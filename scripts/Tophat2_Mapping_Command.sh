...
function do_job {
    ...
    echo `date` >> ${job_name}.log
    fastq_file=${1##*/}
    tophat2 -g 1 -a 6 --microexon-search -m 2 -p 10 -G /picb/rnomics1/database/Mouse/mm10/annotation/knownGene.gtf -o ./${fastq_file%%.*}  /picb/rnomics1/database/Mouse/mm10/genome/mm10_all $1 &> ${fastq_file%%.*}_tophat2.log
}
